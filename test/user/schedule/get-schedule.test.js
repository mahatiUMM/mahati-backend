...
describe("test GET /api/schedule", () => {
  it("should return 200 when getting all schedule by user", async () => {
  ...
  it("should return 500 when error occurs", async () => {
    jest.spyOn(prisma.schedules, "findMany").mockRejectedValue(new Error());
