...
describe("test GET /api/brochure", () => {
  it("should return 200 when getting all brochure by user", async () => {
  ...
  it("should return 500 when error occurs", async () => {
    jest.spyOn(prisma.brochures, "findMany").mockRejectedValue(new Error());
